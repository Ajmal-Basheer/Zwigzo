        ...
        child: SafeArea(
            child:StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (BuildContext context,
                  ...
                  List<DocumentSnapshot<Map<String, dynamic>>> orders = snapshot.data!.docs;
                return Column(
                  children: [
                    Container(
                        ...
                        children: [
                          ...
                          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                              ...
                              builder: (BuildContext context,
                                ...
                                List<DocumentSnapshot<Map<String, dynamic>>> Placedorders = snapshot.data!.docs;
                                return InsightCard(
                                title: 'Placed Orders',
                          ...
                          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                              ...
                              builder: (BuildContext context,
                                ...
                                List<DocumentSnapshot<Map<String, dynamic>>> Activeorders = snapshot.data!.docs;
                                return InsightCard(
                                title: 'Active Orders',
                          ...
                          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                              ...
                              builder: (BuildContext context,
                                ...
                                List<DocumentSnapshot<Map<String, dynamic>>> Cancelledorders = snapshot.data!.docs;
                                return  InsightCard(
