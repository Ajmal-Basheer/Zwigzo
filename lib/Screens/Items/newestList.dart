...
class newestItems extends StatefulWidget {  @override
State<StatefulWidget> createState() => newestItemsState();
}
class newestItemsState extends State {
  bool _newestItemsfav = false;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Newest',style: GoogleFonts.jost(fontSize: 20),),
          leading: IconButton(
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text('Chicken Burger',
                                            style: GoogleFonts.fjallaOne(fontSize: 15,),
                                          ),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text('Restaurants Name',
                                            style: GoogleFonts.abel(fontSize: 11,),
                                          ),
                                        ),
                                      ),
                                      Row(
                                        children: [
                                          ...
                                          Text('100', style: GoogleFonts.notoSans(fontSize: 22,
                                              fontWeight: FontWeight.bold,
                                              color: primaryColor),),
                                          SizedBox(width: 30,),
                                          IconButton(
                                            icon: Icon(
                                              _newestItemsfav ? Icons.favorite : Icons.favorite_border,
                                              color: primaryColor,),
                                            onPressed: () {
                                              setState(() {
                                                _newestItemsfav = !_newestItemsfav;
                                              });
                                            },
                                          ),
                                        ],
